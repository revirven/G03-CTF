...
@section('content')
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="row hackerFont">
                        <div class="col-md-6">
                            ...
                            @enderror
                            <form id="form_login" method="post" action="{{ route('user.auth') }}">
                                @CSRF
            ...
            <div class="row">
                <div class="col-xl-8">
                    <button type="submit" class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" form="form_login">
                    <h4>Login</h4>
                    </button>
