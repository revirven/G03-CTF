                    ...
                    <div class="row justify-content-center  hackerFont ">
                        <div class="col-md-10">
                            ...
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='{{-- route('home.challenges') --}}'})();">
